...
- **Party up with the bots and go adventuring.** Use the normal party gump (or the context menu): target a bot, and after a beat it accepts — "im in" — and it's in your party bar for real. Party members follow you (running to keep up), jump into your fights and defend the group, and when you remove them or log off they say their goodbyes and wander back to their own lives. Busy bots decline like people do: crafters are working, dungeon crawlers are mid-run, and the bank fixtures are "waiting on someone here". A member who dies ghosts off to a healer — re-invite them after the res, like everyone did.
