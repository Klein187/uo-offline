...
- **Tamers fight with their pets now.** A Tamer heading out to hunt brings the real weapon: a controlled fighting pet laddered to what its Animal Taming can genuinely hold — a Novice walks with a timber wolf, mid-tiers with panthers and grizzlies, and a Grandmaster with the era's dream stable: a **nightmare, white wyrm, or the odd dragon**. In a fight the tamer sics the pet on its target with the era's most typed sentence — **"all kill"** — vet-bandages it when it's hurt, keeps it fed so it never goes wild, and the pet teleport-catches-up after recalls and stairs (dungeon-crawling tamers bring their beast down with them). Pets follow their tamer through town between hunts — the nightmare parade at the bank is back. Strict no-leak lifecycle: orphaned pets are reaped, restarts sweep strays.
